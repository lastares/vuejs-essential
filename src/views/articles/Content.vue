    ...
    <div class="col-md-9 left-col pull-right">
                ...
                <div class="voted-users">
                    <div class="user-lists">
                        <span v-for="likeUser in likeUsers">
                          ...
                          <img :src="user && user.avatar" class="animated swing img-thumbnail avatar avatar-middle" :class="{ 'animated swing' : likeUser.uid === 1 }">
                        </span>
                    </div>
        ...
        <div class="replies panel panel-default list-panel replies-index">
            ...
            <div class="panel-body">
                <transition-group name="fade" id="reply-list" class="list-group row">
